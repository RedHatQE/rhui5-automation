...
class TestRhuiManagerStatus():
    ...
    def test_08_check_expiration():
        ...
        Config.set_rhui_tools_conf(RHUA, "rhui", "expiration_warning", "36525")
    ...
    def test_09_check_broken_external_service():
        ...
        Expect.expect_retval(HAPROXY, "ha systemctl stop haproxy")
    ...
    def test_10_repo_status_json(self):
        ...
        _, stdout, _ = RHUA.exec_command(f"rhua cat {MACH_READ_FILE}")
    ...
    def test_12_check_expired_ssl_cert(self):
        ...
        _, stdout, _ = RHUA.exec_command("cat /var/lib/rhui/root/test_files/rhcert_expired.pem")
    ...
    def test_13_check_broken_pulp_worker_service(self):
        ...
        # for RHBZ#2174633
        Expect.expect_retval(HAPROXY, "ha systemctl start haproxy")
        ...
        Expect.expect_retval(RHUA, "rhua systemctl stop pulpcore-worker@2")
